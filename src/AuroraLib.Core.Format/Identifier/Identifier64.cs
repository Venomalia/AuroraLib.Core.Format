...
namespace AuroraLib.Core.Format.Identifier
{
    ...
    /// </summary>
    [Serializable]
    public readonly unsafe struct Identifier64 : IIdentifier
    {
        /// <summary>
        /// The lower 32-bit identifier.
        /// </summary>
        public readonly Identifier32 Lower;

        /// <summary>
        /// The higher 32-bit identifier.
        /// </summary>
        public readonly Identifier32 Higher;
        ...
        public Identifier64(ReadOnlySpan<char> span)
        {
            ...
            Helper.DefaultEncoding.GetBytes(span64, bytes);
        ...
        public ReadOnlySpan<byte> AsSpan()
        {
            ...
            ref byte tRef = ref Unsafe.As<Identifier32, byte>(ref Unsafe.AsRef(in Lower));
        ...
        public static implicit operator ReadOnlySpan<byte>(in Identifier64 v) => v.AsSpan();
