...
namespace AuroraLib.Core.Format.Identifier
{
    ...
    /// </summary>
    [Serializable]
    public unsafe readonly struct Identifier32 : IIdentifier
    {
#pragma warning disable IDE0044
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        private readonly byte b0, b1, b2, b3;
#pragma warning restore IDE0044
        ...
        public Identifier32(ReadOnlySpan<char> span)
        {
            ...
            Helper.DefaultEncoding.GetBytes(span32, bytes);
...
#else
            => MemoryMarshal.CreateReadOnlySpan(ref Unsafe.AsRef(in b0), 4);
#endif
